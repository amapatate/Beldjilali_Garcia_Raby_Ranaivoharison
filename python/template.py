  ...
  <nav class="header container main ">
    ...
    <nav class="header container main ">
      ...
      <div class= "login col-md-4">
        <ul>
          <li><a href="/IENAC15/beldjilali_garcia_raby_ranaivoharison/python/PageClient/MyAcount.py/MyAcount">''' + Session()["prenom"] + '''</a></li>
    ...
    <nav class="header container main ">
      ...
      <div class= "login col-md-4">
        <ul>
          <li><a href="/IENAC15/beldjilali_garcia_raby_ranaivoharison/python/PageAgriculteur/MyAcountAgri.py/MyAcountAgri">''' + Session()["prenom"] + '''</a></li>
          <li><a href="/IENAC15/beldjilali_garcia_raby_ranaivoharison/python/prive.py/deconnect">Se Déconnecter</a></li>
        </ul>
      </div>
  </nav>'''
