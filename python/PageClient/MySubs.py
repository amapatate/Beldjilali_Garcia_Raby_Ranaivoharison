      ...
      <div class=" col-md-4">
        ...
        <table data-toggle="table" data-search="true" data-pagination="true" data-page-size="3">
            <thead>
            	<tr>
            		...
            		<th data-field="nom" data-sortable="true">'''+ str(bdd.getNomPrenomAgriFromId(panier[1])[0]) + ' ' + bdd.getNomPrenomAgriFromId(panier[1])[1] +'''</th>
               </tr>
            </thead>
            <tbody>'''
        ...
        abo += '''
         ...
         <div class="abo col-md-2" style="text-align:center;">
          	<a href="/IENAC15/beldjilali_garcia_raby_ranaivoharison/python/PageClient/MySubs.py/insertSubs?id_client='''+str(Session()["id"])+''';id_panier='''+str(panier[0])+'''"> S'Abonner </a>
          </div>
          </center>
          '''
                ...
                <center>
                   ...
                   data-toggle="table" data-search="true" data-pagination="true" data-page-size="3">
                       <thead>
                          ...
                          <th class="delete" data-field="nom" data-sortable="true"> <a href="/IENAC15/beldjilali_garcia_raby_ranaivoharison/python/PageClient/MySubs.py/deleteSubs?id='''+str(panier[2])+'''"> X </a></th>
                        </thead>
                   </table>
                 </center>
                 </div>
